    ...
    <div class="flex-1 overflow-y-auto pt-5 space-y-5 pb-8">
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3.5 pt-1">
          <!-- Dark Option -->
          <div
            class="border rounded-xl p-4 cursor-pointer flex items-center justify-between transition-all"
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <div class="text-[11px] mt-0.5" :class="themeStore.isDark ? 'text-zinc-400' : 'text-zinc-500'">曜石极客黑白</div>
              </div>
            </div>
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <div class="text-[11px] mt-0.5" :class="themeStore.isDark ? 'text-zinc-400' : 'text-zinc-500'">清爽高对比度</div>
              </div>
            </div>
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <div class="text-[11px] mt-0.5" :class="themeStore.isDark ? 'text-zinc-400' : 'text-zinc-500'">自动匹配操作系统</div>
              </div>
            </div>
